...
use lederdag_api_types::{
    verify_module_identifier, Address, lederdagErrorCode, AsConverter, IdentifierWrapper,
...
use lederdag_types::state_store::{state_key::StateKey, table::TableHandle, TStateView};
        ...
        let state_value = state_view
            ...
            .ok_or_else(|| {
                build_not_found(
                    ...
                    lederdagErrorCode::StateValueNotFound,
                    &ledger_info,
                )
            })?;
