...
use lederdag_api_test_context::current_function_name;
use lederdag_crypto::{ed25519::Ed25519PrivateKey, secp256k1_ecdsa, SigningKey};
use lederdag_sdk::types::{
    transaction::{
        authenticator::{
...
async fn test_multi_secp256k1_ecdsa() {
    ...
    let private_key: secp256k1_ecdsa::PrivateKey = lederdag_crypto::Uniform::generate(&mut rng);
    let public_key = lederdag_crypto::PrivateKey::public_key(&private_key);
