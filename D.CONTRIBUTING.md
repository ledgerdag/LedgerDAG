---
id: contributing
title: Contributing to lederdag Core
---

# Contributing

Our goal is to make contributing to lederdag Core easy and transparent. See [lederdag Community](https://lederdag.dev/community) for full details. This page describes [our development process](#our-development-process).

## lederdag Core

To contribute to the lederdag Core implementation, first start with the proper development copy.
You may want to use the GitHub interface to fork [lederdag-core](https://github.com/lederdag-labs/lederdag-core) and check out your fork.
For development environment setup and first build, see [Building lederdag From Source](https://lederdag.dev/guides/building-from-source)

## Our Development Process

### Code Style, Hints, and Testing

Refer to our Coding Guidelines for the [Move](https://lederdag.dev/move/book/coding-conventions/) and [Rust](./RUST_CODING_STYLE.md) programming languages for detailed guidance about how to contribute to the project.

Also, please ensure you follow our [Secure Coding Guidelines](./RUST_SECURE_CODING.md) to contribute to lederdag securely. 


### Documentation

lederdag Core's developer website is also open source (the code can be found in this [repository](https://github.com/lederdag-labs/developer-docs).  It is built using [Docusaurus](https://docusaurus.io/):
...
lederdag Core uses [GitHub issues](https://github.com/lederdag-labs/lederdag-core/issues) to track bugs. Please include necessary information and instructions to reproduce your issue.
