...
use lederdag_resource_viewer::{AnnotatedMoveStruct, AnnotatedMoveValue};
use lederdag_types::{account_config::CORE_CODE_ADDRESS, event::EventKey, transaction::Module};
...
mod tests {
    use super::*;
    use lederdag_types::account_address::AccountAddress;
    use move_core_types::{
        ability::AbilitySet,
        identifier::Identifier,
    ...
    fn test_parse_invalid_move_module_id_string() {
        ...
        assert_eq!(
            "Invalid Move module ID: lederdag::lederdag",
            "lederdag::lederdag"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid Move module ID: 0x1::lederdag::lederdag",
            "0x1::lederdag::lederdag"
                .parse::<MoveModuleId>()
                .err()
                .unwrap()
                .to_string()
    ...
    fn test_parse_invalid_move_entry_function_id_string() {
        ...
        assert_eq!(
            "Invalid entry function ID lederdag::lederdag",
            "lederdag::lederdag"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
        ...
        assert_eq!(
            "Invalid entry function ID 0x1::lederdag::lederdag::lederdag",
            "0x1::lederdag::lederdag::lederdag"
                .parse::<EntryFunctionId>()
                .err()
                .unwrap()
                .to_string()
