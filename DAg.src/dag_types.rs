...
pub const BCS_VIEW_FUNCTION: &str = "application/x.lederdag.view_function+bcs";

pub const BCS_SIGNED_TRANSACTION: &str = "application/x.lederdag.signed_transaction+bcs";
