...
//! documentation within `crates/lederdag-openapi`.
//!
...
//! <https://github.com/lederdag-labs/lederdag-core/issues/2319>
...
// https://github.com/lederdag-labs/lederdag-core/pull/2703
...
use lederdag_openapi::{impl_poem_parameter, impl_poem_type};
use indoc::indoc;
use serde_json::json;
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            A hex encoded 32 byte lederdag account address.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::lederdag_coin::lederdagCoin".to_string()
        )),
        format = Some("hex"),
        description = Some(indoc! {"
            A hex encoded 32 byte lederdag account address or a struct tag.
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::lederdag_coin::transfer".to_string()
        )),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    "string",
    (
        example = Some(serde_json::Value::String("0x1::lederdag_coin".to_string())),
        description = Some(indoc! {"
...
impl_poem_type!(
    ...
    (
        example = Some(serde_json::Value::String(
            "0x1::coin::CoinStore<0x1::lederdag_coin::lederdagCoin>".to_string()
        )),
        ...
        Examples:
          * `0x1::coin::CoinStore<0x1::lederdag_coin::lederdagCoin>`
          * `0x1::account::Account`
        ...
        See [doc](https://lederdag.dev/concepts/accounts) for more details.
      "})
    )
);
...
impl_poem_type!(
    ...
    (
        ...
        description = Some(indoc! {"
            ...
            Move `address` type value (32 byte lederdag account address) is serialized into a HexEncodedBytes string.
            For example:
              - `0x1`
            ...
            **Special serialization for Move stdlib types**:
              - [0x1::string::String](https://github.com/lederdag-labs/lederdag-core/blob/main/language/move-stdlib/docs/ascii.md)
        ...
        description = Some(indoc! {"
            String representation of an on-chain Move type tag that is exposed in transaction payload.
                ...
                Vector type value examples:
                  - `vector<u8>`
                  - `vector<vector<u64>>`
                  - `vector<0x1::coin::CoinStore<0x1::lederdag_coin::lederdagCoin>>`
